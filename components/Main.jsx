    ...
    <div id="home" className='w-full h-screen text-center bg-transparent'>
        <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
            <div>        
                ...
                <p className='py-4 text-gray-200 max-w-[70%] m-auto'>Blah blah blah.  Here's some text about me and something I do and what I'm looking for (possibly?).  Currently I'm focused on blah blah while also learning blah blah </p>
