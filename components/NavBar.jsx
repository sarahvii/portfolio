        ...
        <div className={nav ? 'fixed left-0 top-0 w-[75%] sm:w-[45%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500' : 'fixed left-[-100%] top-0  p-10 ease-in duration-500'}>
            <div>
                <div className="flex w-full items-center justify-between">
                    <Link href='/'>
                    <Image src='./assets/sslogo.svg' alt='/' width={30} height={30}/>
                    </Link>
                ...
                <div className="border-b border-gray-300 my-4">
                    <p className='w-[85%] md:w-[90%] py-4'>A little tagline.</p>
                </div>
            </div>
            <div className='py-4 flex flex-col'>
                ...
                <div className="pt-40">
                    <p className="uppercase tracking-widest text-[#5aa06a]">Let&apos;s Connect</p>
